...
struct PtSituationElement {
    ...
    situation_shared_identity: SituationSharedIdentityGroup, // Référence à une SITUATION
    country_ref: Option<String>, // Code Pays du participant
    participant_ref: String, // Identifiant du système participant
    situation_number: String, // Identifiant unique d’une SITUATION pour un Participant
